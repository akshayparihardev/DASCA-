...
const Footer = () => {
  ...
  return (
    <footer
      className="w-full flex justify-center py-12 px-5 md:py-[80px] md:px-[40px] overflow-hidden bg-[#050505] text-white"
    ...
    >
      <div className="w-full max-w-[1400px] flex flex-col gap-16 md:gap-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-start">
          ...
          <div className="md:col-span-5 flex flex-col gap-8">
            ...
            <div>
              ...
              <div className="pt-2 text-[1.6rem] md:text-[1.9rem] leading-[1.35] font-semibold tracking-wide text-gray-200">
                <p className="opacity-90">Data Science</p>
                <p className="opacity-90">Department</p>
                <p className="font-bold mt-1 bg-gradient-to-r from-gray-100 to-gray-300 bg-clip-text text-transparent">
                  RBU Nagpur
                </p>
              </div>
            </div>
              ...
              <div className="flex flex-col gap-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`group flex items-center gap-4 px-4 py-3 rounded-2xl transition-all duration-300 ${social.textColor} bg-[#1A1A1A] text-white border border-transparent`}
                  >
                    {/* Icon */}
          ...
          <div className="hidden md:block md:col-span-1">
            <div className="w-[1px] h-full mx-auto bg-gradient-to-b from-transparent via-gray-700 to-transparent opacity-50"></div>
          </div>
          <div className="block md:hidden w-full h-[1px] bg-gradient-to-r from-transparent via-gray-700 to-transparent opacity-30"></div>

          {/* ===== RIGHT: CTA SECTION (6 COLUMNS) ===== */}
          <div className="md:col-span-6 flex flex-col items-center justify-center gap-8 min-h-[400px]">
            ...
            <div className="relative w-full overflow-hidden mb-4">
              <div className="relative h-[80px] flex items-center justify-center">
                {quotes.map((quote, index) => (
                  <div
                    key={index}
                    className={`absolute w-full text-center transition-all duration-700 ease-in-out ${index === currentQuote
              ...
              <div className="flex justify-center gap-2 mt-3">
                {quotes.map((_, i) => (
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all duration-300 ${i === currentQuote
              ...
              <div className="flex flex-col items-center gap-4">
                {quickLinks.map((link) => (
                  <a
                    key={link.name}
                    href={link.href}
                    className="group relative inline-flex items-center gap-3 text-[1rem] md:text-[1.1rem] font-semibold transition-all duration-300 text-white"
                  >
                    {/* Text with Underline */}
        ...
        {/* ========== BOTTOM SECTION ========== */}
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-[0.7rem] font-bold tracking-[0.12em] uppercase gap-6 md:gap-4 text-gray-300">
          ...
          {/* Right: Like Section */}
          <div className="order-1 md:order-3 flex items-center gap-4 border-t border-dashed border-gray-800 md:border-none pt-4 md:pt-0 w-full md:w-auto justify-center md:justify-end">
            ...
            <div className="flex items-center gap-2 cursor-pointer select-none group" onClick={handleLike}>
              ...
              <span
                ...
                style={{
                  ...
                  color: liked ? 'transparent' : '#4B5563'
                }}
              >
                favorite
              </span>
